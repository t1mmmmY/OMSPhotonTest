...
public class P2PManager
{
    ...
    void PeerConnectRequestCallback(Message<Oculus.Platform.Models.NetworkingPeer> msg)
    {
    ...
    void ConnectionStateChangedCallback(Message<Oculus.Platform.Models.NetworkingPeer> msg)
    {
