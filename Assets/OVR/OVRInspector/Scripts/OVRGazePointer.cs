...
public class OVRGazePointer : MonoBehaviour {
    ...
    void LateUpdate()
    {
        ...
        //{
            // Make the cursor face directly at the camera
            if( transform.position - rayTransform.position != Vector3.zero)
                transform.rotation = Quaternion.LookRotation(transform.position - rayTransform.position);
        //}
